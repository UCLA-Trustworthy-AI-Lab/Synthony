...
print(f"Available: {', '.join([m['name'] for m in models['models'][:5]])}...")

# Test 3: Get Specific Model Info
print("\n3. Testing Get Model Info (GReaT)")
print("-" * 80)
...
print("\n4. Testing Analyze-and-Recommend (Titanic dataset)")
print("-" * 80)
...
if response.status_code == 200:
    ...
    print("\nDataset Profile:")
    print(f"  Size: {profile['row_count']} rows x {profile['column_count']} columns")
...
print("\n5. Testing with Insurance dataset")
print("-" * 80)
