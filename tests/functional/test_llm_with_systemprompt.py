...
print("\n2. Rule-based recommendation (baseline)")
print("-" * 80)
...
print("\n3. LLM recommendation (with SystemPrompt)")
print("-" * 80)
...
print("\n4. Hybrid recommendation (rule + LLM)")
print("-" * 80)
...
print("\n6. Testing with Abalone dataset (different characteristics)")
print("-" * 80)
